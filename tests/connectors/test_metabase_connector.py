...
def _connector() -> tuple[MetabaseToolSet, MockTransport]:
...
def test_metabase_list_tools_register_first_class_output_schemas() -> None:
    ...
    expected: dict[str, str] = {
        "METABASE_list_cards": "cards",
        "METABASE_list_dashboards": "dashboards",
    }
...
def test_metabase_output_schemas_not_published_through_metadata() -> None:
    connector, _ = _connector()
    opts = get_toolify_options(connector.list_cards)
