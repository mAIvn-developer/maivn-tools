...
def _connector() -> tuple[MailgunToolSet, MockTransport]:
...
def test_mailgun_list_tools_register_first_class_output_schemas() -> None:
    ...
    expected: dict[str, str] = {
        "MAILGUN_list_domains": "domains",
        "MAILGUN_list_mailing_lists": "lists",
    }
...
def test_mailgun_output_schemas_not_published_through_metadata() -> None:
    connector, _ = _connector()
    for method in (connector.list_domains, connector.list_mailing_lists):
