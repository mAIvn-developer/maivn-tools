...
def _connector() -> tuple[OnePasswordToolSet, MockTransport]:
...
def test_onepassword_list_tools_register_first_class_output_schemas() -> None:
    ...
    expected: dict[str, str] = {
        "ONEPASSWORD_list_vaults": "vaults",
        "ONEPASSWORD_list_items": "items",
    }
...
def test_onepassword_output_schemas_not_published_through_metadata() -> None:
    connector, _ = _connector()
    opts = get_toolify_options(connector.list_vaults)
