...
def _connector() -> tuple[ShopifyToolSet, MockTransport]:
...
def test_shopify_list_tools_register_first_class_output_schemas() -> None:
    ...
    expected: dict[str, str] = {
        "SHOPIFY_list_products": "products",
        "SHOPIFY_list_orders": "orders",
        "SHOPIFY_list_customers": "customers",
    }
...
def test_shopify_output_schemas_not_published_through_metadata() -> None:
    connector, _ = _connector()
    opts = get_toolify_options(connector.list_products)
