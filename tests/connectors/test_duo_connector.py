...
def _connector() -> tuple[DuoToolSet, MockTransport]:
...
def test_duo_list_tools_register_first_class_output_schemas() -> None:
    ...
    expected: dict[str, str] = {
        "DUO_list_users": "users",
        "DUO_list_phones": "phones",
        "DUO_list_groups": "groups",
    }
...
def test_duo_output_schemas_not_published_through_metadata() -> None:
    connector, _ = _connector()
    for method in (connector.list_users, connector.list_phones, connector.list_groups):
