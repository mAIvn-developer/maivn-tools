...
def _connector() -> tuple[BitbucketToolSet, MockTransport]:
    transport = MockTransport()
    connector = BitbucketToolSet(email="u", api_token="p", transport=transport)
...
def test_bitbucket_list_tools_register_first_class_output_schemas() -> None:
    ...
    expected: dict[str, str] = {
        "BITBUCKET_list_repositories": "repositories",
        "BITBUCKET_list_pull_requests": "pull_requests",
        "BITBUCKET_list_issues": "issues",
        "BITBUCKET_list_pipelines": "pipelines",
        "BITBUCKET_list_branches": "branches",
    }
...
def test_bitbucket_output_schemas_not_published_through_metadata() -> None:
    connector, _ = _connector()
