...
def _connector() -> tuple[BitwardenToolSet, MockTransport]:
...
def test_bitwarden_list_tools_register_first_class_output_schemas() -> None:
    ...
    expected: dict[str, str] = {
        "BITWARDEN_list_secrets": "secrets",
    }
...
def test_bitwarden_output_schemas_not_published_through_metadata() -> None:
    connector, _ = _connector()
    opts = get_toolify_options(connector.list_secrets)
