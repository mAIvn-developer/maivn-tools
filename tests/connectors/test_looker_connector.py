...
def _connector() -> tuple[LookerToolSet, MockTransport]:
...
def test_looker_list_tools_register_first_class_output_schemas() -> None:
    ...
    expected: dict[str, str] = {
        "LOOKER_list_looks": "looks",
        "LOOKER_list_dashboards": "dashboards",
        "LOOKER_list_users": "users",
    }
...
def test_looker_output_schemas_not_published_through_metadata() -> None:
    connector, _ = _connector()
    opts = get_toolify_options(connector.list_looks)
