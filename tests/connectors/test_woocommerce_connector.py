...
from maivn_tools.connectors.woocommerce.connector import WooCommerceToolSet


def _connector() -> WooCommerceToolSet:
    return WooCommerceToolSet(
...
def test_woocommerce_list_tools_register_first_class_output_schemas() -> None:
    ...
    expected: dict[str, str] = {
        "WOO_list_products": "products",
        "WOO_list_orders": "orders",
        "WOO_list_customers": "customers",
    }
...
def test_woocommerce_output_schemas_not_published_through_metadata() -> None:
    connector = _connector()
    for method in (
