...
def _connector() -> tuple[HexToolSet, MockTransport]:
    transport = MockTransport()
    connector = HexToolSet(api_token="hex_secret", transport=transport)
...
def test_hex_list_tools_register_first_class_output_schemas() -> None:
...
def test_hex_output_schemas_not_published_through_metadata() -> None:
    connector, _ = _connector()
