...
def _connector() -> tuple[RipplingToolSet, MockTransport]:
    transport = MockTransport()
    connector = RipplingToolSet(access_token="t", transport=transport)
...
def test_rippling_list_tools_register_first_class_output_schemas() -> None:
    ...
    expected: dict[str, str] = {
        "RIPPLING_list_employees": "employees",
    }
...
def test_rippling_output_schemas_not_published_through_metadata() -> None:
    connector, _ = _connector()
