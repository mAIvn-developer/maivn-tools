...
def _connector() -> tuple[InteractiveBrokersToolSet, MockTransport]:
...
def test_ibkr_list_tools_register_first_class_output_schemas() -> None:
    ...
    expected: dict[str, str] = {
        "IBKR_list_positions": "positions",
        "IBKR_list_orders": "orders",
    }
...
def test_ibkr_output_schemas_not_published_through_metadata() -> None:
    connector, _ = _connector()
    for method in (connector.list_positions, connector.list_orders):
