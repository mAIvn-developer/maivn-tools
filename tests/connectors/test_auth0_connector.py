...
def _connector() -> tuple[Auth0ToolSet, MockTransport]:
...
def test_auth0_list_tools_register_first_class_output_schemas() -> None:
    ...
    expected: dict[str, str] = {
        "AUTH0_list_users": "users",
        "AUTH0_list_roles": "roles",
        "AUTH0_list_connections": "connections",
        "AUTH0_list_clients": "apps",
        "AUTH0_list_organizations": "organizations",
    }
...
def test_auth0_output_schemas_not_published_through_metadata() -> None:
    connector, _ = _connector()
