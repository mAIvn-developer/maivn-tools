...
def _connector() -> tuple[WorkdayToolSet, MockTransport]:
...
def test_workday_list_tools_register_first_class_output_schemas() -> None:
    ...
    expected: dict[str, str] = {
        ...
        "WORKDAY_list_job_postings": "jobs",
        "WORKDAY_list_candidates": "candidates",
    }
...
def test_workday_output_schemas_not_published_through_metadata() -> None:
    connector, _ = _connector()
    for method in (
        connector.list_workers,
        connector.list_job_postings,
