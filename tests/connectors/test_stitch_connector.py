...
def _connector() -> tuple[StitchToolSet, MockTransport]:
    transport = MockTransport()
    connector = StitchToolSet(access_token="tok_secret", transport=transport)
...
def test_stitch_list_tools_register_first_class_output_schemas() -> None:
...
def test_stitch_output_schemas_not_published_through_metadata() -> None:
    connector, _ = _connector()
